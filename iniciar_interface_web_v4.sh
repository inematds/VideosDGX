#!/bin/bash
# Interface Web v4 - Multi-Model Video Generation
# Modelos: Wan 2.2 14B MoE, Wan 2.2 5B, LTX-2 19B
...
echo ""
echo "🎬 Interface Web v4 - Geração de Vídeos"
echo "   Modelos: Wan 2.2 14B MoE | Wan 2.2 5B | LTX-2 19B"
echo "   Acesso: http://localhost:7860"
echo ""
echo "Pressione Ctrl+C para parar"
echo ""

python3 web_interface_v4.py
